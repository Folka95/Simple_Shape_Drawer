...
private:
    ...
    void drawCurveHermite(Shape* shape,Point t0, Point t1, Point p0, Point p3, ScreenWriter *sw, const Shape& clippingRegion) const;
    void drawCurveBezier(Shape* shape,Point c1, Point c2, Point p0, Point p3, ScreenWriter *sw, const Shape& clippingRegion) const;
public:
